...
public class OrderCreatedEvent {
	...
	public OrderCreatedEvent(Long orderId, Long userId, String userName, String userEmail, String userPhone, List<OrderItemSnapshot> items, Integer totalQuantity, Double totalPrice, String discountCode, Double discountAmount) {
